...
import { Card, CardContent, CardHeader as CardHeaderSection, CardTitle as CardTitleSection } from "@/components/ui/card"
        ...
        <div>
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              {/* Download buttons can be implemented as needed */}
            </div>
            {/* Executive Summary */}
            <Card className="mb-6">
              <CardHeaderSection>
                <CardTitleSection className="flex items-center gap-2">
